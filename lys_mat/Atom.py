...
class Atom(object):
    ...
    def Z(self):
        ...
        Returns:
            The atomic number of the current object.
    ...
    def subs(self, *args, **kwargs):
        ...
        Returns:
            A new Atom object with the substituted sympy objects.
    ...
    def free_symbols(self):
        ...
        Returns:
            The set of free symbols in the current object.
    ...
    def saveAsDictionary(self):  # save as string like
        ...
        Returns:
            A dictionary containing the all information of the atom.
    ...
    def loadFromDictionary(cls, d):
        ...
        Returns:
            An `Atom` object with the loaded data.
